    ...
    return (
        <Card className="col-span-1 h-full flex flex-col min-h-[400px]">
            <div className="flex items-center justify-between mb-2">
                 ...
                 <span className="text-xs px-3 py-1 bg-blue-50 text-blue-600 rounded-full font-medium">Last 7 Days</span>
            </div>
            <p className="text-sm text-slate-500 mb-6">Your comprehensive daily spending overview.</p>
